...
\begin{theorem}[Mokhov conditions; \cite{Mochov}]
...
\begin{theorem}[Mokhov; \cite{Mochov}]
...
\begin{example}[Classification of one-component brackets; \cite{Mochov}]
...
\begin{theorem}[Mutual compatibility of the metrics; \cite{Mochov}] 
...
\begin{definition}[Nonsingular pair of metrics]
...
\begin{theorem}[Mokhov classification theorem; \cite{Mochov}]
