...
I have to express my gratitude to my friends who helped me finish this thesis, especially to Michal Grňo for discussions about the mathematical ideas, to Rozka Hájková for the emmotional support throughout my whole bachelor studies and to Josef Lamken for helping me with English.
...
\def\Abstract{%
We investigate the systems of quasilinear partial differential equations of hydrodynamic type. These equations occur mostly in hydrodynamics and continuum mechanics, but they arise in other various applications. In study of such systems one finds an intersection of Poisson and pseudo-Riemannian geometry. The existence of Poisson structure is equivalent to the existence of flat metric and Levi-Civita covariant derivative with zero curvature. Moreover, one can find special flat coordinates, where the bracket is trivial. This result was found in the eighties by Dubrovin and Novikov for the one-dimensional case and later on extended to more dimensions. In this thesis we provide the proof of the Dubrovin-Novikov theorem more detailed than in the original paper. We also conducted an overview of current knowledge in multi-dimensional case, where the theory gets much more complicated. In particular, the link between the compatible brackets and the possibility of finding flat coordinates is discussed.
}

% 3 to 5 keywords (recommended), each enclosed in curly braces
\def\Keywords{%
{hydrodynamics}, {Poisson bracket}, {pseudo-Riemannian geometry}, {Dubrovin-Novikov theorem}
}
...
%\include{formal/preface}
\input{formal/preface}
\input{chapters/Riemann.tex}
\input{chapters/Poisson.tex}
\include{chapters/Hydrodynamics}


\include{chapters/Theorem.tex}
\input{chapters/Multi-dimensional.tex}
\include{formal/epilog}
...
\appendix
\include{chapters/Mathematical-Framework.tex}
%\openright
\end{document}
